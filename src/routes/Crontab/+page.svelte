...
var text = `This code runs every hour, on the hour. I want it to continue to run, and I also want a modified version that says "Deep breathing" every hour on the half hour.
