...
<pre>{sh}</pre>
<p> Edit the application in VS Code and push it to Github. Then, in the server, where the application has been cloned, run "git pull origin main". Restart the .service file with "sudo systemctl restart blog" </p>
