function _page($$payload) {
  $$payload.out += `<h1>Using Crontab For Reminders</h1> <pre>This code runs every hour, on the hour. I want it to continue to run, and I also want a modified version that says "Deep breathing" every hour on the half hour.
...
The cron daemon will automatically pick up the changes.</pre>`;
}

export { _page as default };
//# sourceMappingURL=_page.svelte-C6kBguo5.js.map
